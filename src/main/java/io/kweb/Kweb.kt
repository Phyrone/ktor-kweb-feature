...
import de.phyrone.kwebfeature.AbstractKweb
...
class Kweb(val port: Int,
           ...
           override val plugins: List<io.kweb.plugins.KwebPlugin> = java.util.Collections.emptyList(),
...
""".trimIndent())
    ...
    override fun isCatchingOutbound() = outboundMessageCatcher.get() != null

    override fun isNotCatchingOutbound() = !isCatchingOutbound()
    ...
    override fun send(clientId: String, instructions: List<Instruction>) {
